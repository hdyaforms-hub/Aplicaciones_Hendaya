...
export default function OrganigramaClient({
    ...
    const handleMouseMove = (e: React.MouseEvent) => {
        // Calculate offset position for the premium absolute floating tooltip
        setTooltipPos({
            x: e.clientX + 15,
            y: e.clientY + 15
        })
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                ...
                <div className="w-full sm:w-72 space-y-1">
                    ...
                    <select
                        ...
                        className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 bg-white font-semibold text-slate-800 outline-none transition-all shadow-sm"
                    >
                                                                        ...
                                                                        {supervisores.map((sup) => {
                                                                            ...
                                                                            return (
                                                                                <div
                                                                                    ...
                                                                                    className={`p-4 rounded-xl border transition-all cursor-help relative group ${
                                                                                        isHovered 
                                                                                            ? 'bg-cyan-50/50 border-cyan-400 shadow-md scale-[1.02]' 
                                                    ...
                                                    {directSupervisores.map((sup) => {
                                                        ...
                                                        return (
                                                            <div
                                                                ...
                                                                onMouseLeave={() => setHoveredSuperId(null)}
                                                                onMouseMove={handleMouseMove}
                                                                className={`p-5 rounded-2xl border transition-all cursor-help w-full max-w-xs relative group ${
                                                                    isHovered 
                                                                        ? 'bg-amber-50/40 border-amber-400 shadow-md scale-[1.02]' 
                ...
                (() => {
                    ...
                    return (
                        <div
                            ...
                            className="w-80 bg-slate-900/95 backdrop-blur-md text-white p-5 rounded-2xl shadow-2xl border border-slate-700/50 space-y-4 max-h-[400px] overflow-y-auto pointer-events-none transition-opacity duration-200"
                        >
                            {/* Supervisor header */}
