        ...
        return (
            <div className="space-y-6">
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center justify-center py-20 text-center">
                    ...
                    <Link href="/dashboard/mantenedor/operaciones/colegios" className="mt-6 px-6 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-xl transition-colors">
                        ← Volver a Mantenedor
                    </Link>
                </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900 tracking-tight flex items-center gap-3">
                        <Link href="/dashboard/mantenedor/operaciones/colegios" className="text-gray-400 hover:text-cyan-600 transition-colors" title="Volver">←</Link>
