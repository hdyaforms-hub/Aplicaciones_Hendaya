...
export default function PersonalClient({
    ...
    const [distSort, setDistSort] = useState<{ col: string; dir: 'asc' | 'desc' }>({ col: 'recorrido', dir: 'desc' })
    ...
    .filter(s => {
        ...
        const matchSuc = s.supervisorSucursales.some((su: any) => su.sucursal.nombre.toLowerCase().includes(qSuc))
