...
export default function RoleForm({ availablePermissions }: { availablePermissions: PermissionDef[] }) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Remover permissions del formData nativo para inyectar los seleccionados controlados
            ...
            {isOpen && mounted && createPortal(
                ...
                <div className="mb-5 pb-4 border-b border-slate-100 pr-10">
                    <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-cyan-50 text-cyan-800 border border-cyan-200 mb-1">
                        <span>🛡️</span> Nuevo Perfil de Seguridad
                    </div>
                    <h3 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">
                        Crear Nuevo Perfil
                    </h3>
                    <p className="text-xs text-slate-500 mt-0.5">
                        Define el nombre del rol y asigna los privilegios operativos a los que tendrá acceso.
                    </p>
                </div>
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                <input
                                                                    type="checkbox"
                                                                    checked={isChecked}
                                                                    onChange={() => {}} // Manegado por div onClick
