...
export default async function RolesPage() {
    ...
    const availablePermissions = [
        { id: 'view_tablero', name: 'Tablero de Control', description: 'Acceso visual al reporte gráfico general.' },
        { id: 'manage_users', name: 'Gestionar Usuarios', description: 'Crear, editar o eliminar usuarios.' },
        { id: 'manage_roles', name: 'Gestionar Roles', description: 'Administrar mantenedor de perfiles y permisos.' },
        { id: 'view_reports', name: 'Ver Reportes', description: 'Acceso a visualización de datos de negocio.' },
        { id: 'view_pmpa', name: 'Módulo PMPA', description: 'Acceso a carga de Excel y listado PMPA.' },
        { id: 'view_ingreso_raciones', name: 'Ingreso de Raciones', description: 'Gestión y auditoría de raciones por colegio.' },
        { id: 'view_solicitud_pan', name: 'Solicitud de Pan', description: 'Acceso a la aplicación de Solicitud de Pan.' },
        { id: 'view_colegios', name: 'Mantenedor de Colegios', description: 'Acceso a mantenedor y carga masiva de Colegios.' },
        { id: 'view_productos', name: 'Mantenedor de Productos', description: 'Acceso a mantenedor y carga masiva de Productos.' },
        { id: 'manage_correo', name: 'Configuración de Correo', description: 'Acciones sobre credenciales de correo (Office365).' },
        { id: 'manage_listas', name: 'Listas de Distribución', description: 'Gestión de destinatarios y listas de correos.' },
        { id: 'manage_notificaciones', name: 'Notificaciones por Pantalla', description: 'Asociar listas de distribución a notificaciones de la aplicación.' },
        { id: 'manage_sucursales', name: 'Mantenedor de Sucursales', description: 'Administración de Licitaciones, UTs y Sucursales.' },
    ]
