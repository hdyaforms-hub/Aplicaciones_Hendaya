...
export default async function RolesPage() {
    ...
    const availablePermissions = [
        ...
        { id: 'view_calidad_transporte_higiene', name: 'Transporte e Higiene (Ver)', description: 'Acceso visual al módulo Registro transportista interno higiene y estado Transporte.', category: 'ÁREAS -> CALIDAD' },
        ...
        { id: 'sign_bodega_higiene_personal', name: 'Higiene Personal (Firma Jefe de Bodega)', description: 'Permite validar y firmar la planilla diaria como Jefe de Bodega.', category: 'ÁREAS -> CALIDAD' },
